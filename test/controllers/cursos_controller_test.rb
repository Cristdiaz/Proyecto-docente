...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference("Curso.count") do
      post cursos_url, params: { curso: { grado: @curso.grado, letra: @curso.letra, usuario_id: @curso.usuario_id } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { grado: @curso.grado, letra: @curso.letra, usuario_id: @curso.usuario_id } }
